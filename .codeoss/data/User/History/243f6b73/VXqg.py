...
def after_request(response):
    # Manually set CORS headers to troubleshoot potential infrastructure issues
    response.headers.add('Access-Control-Allow-Origin', '*')
    response.headers.add('Access-Control-Allow-Headers', 'Content-Type,Authorization,X-Proxy-Admin-Key')
